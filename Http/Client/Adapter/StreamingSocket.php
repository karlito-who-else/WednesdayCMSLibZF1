<?php 
namespace Wednesday\Http\Client\Adapter;
...
class StreamingSocket extends Zend_Http_Client_Adapter_Socket
{
        ...
        } else
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    // CUSTOM LOGIC HERE!!
					//TODO Handle Twitter Response.
					if($this->_dataHandler != null) {
						$this->_dataHandler->handleResponse($response);
					}
                    //echo $response;
                    echo ".";
                    flush();
