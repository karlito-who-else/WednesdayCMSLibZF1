 ...
 * @version $Id: 1.8.7 RC2 wednesday $    $Id: $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Wednesday_Service_Tumblr
{
	/**
	 * Tumblr email
	 *
	 ...
	 * @return bool
	 */
	public function getPosts($username, $params = array())
	{
            
		$response = $this->_makeRequest("http://$username.tumblr.com" . self::PATH_READ, 'GET', $params);
