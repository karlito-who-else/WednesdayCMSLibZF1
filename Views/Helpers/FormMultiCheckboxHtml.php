<?php
/** Renders checkboxes without html convertions */
require_once 'Zend/View/Helper/FormRadio.php';
class Wednesday_View_Helper_FormMultiCheckboxHtml extends Zend_View_Helper_FormElement
{
/**
 ...
 public function formRadio($name, $value = null, $attribs = null,
     ...
     * @return string The radio buttons XHTML.
     */
    public function formMultiCheckboxHtml($name, $value = null, $attribs = null,
        $options = null, $listsep = "<br />\n")
    {
